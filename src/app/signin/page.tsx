...
const handleSubmit = () =>{
   ...
   <div className="grid place-items-center min-h-screen ">
     ...
     <div className=" flex flex-col p-2 " >
         ...
         <input  id="userName" name="userName" type="text" placeholder="enter your Name" className="p-2 w-[30rem] border-2 border-black rounded-md max-sm:w-[15rem]" onChange={hadleInput}  required/>
     </div>
