...
const formattedDate = `${formattedYear}-${formattedMonth}-${formattedDay}`;
    return(
       ...
       <div className="grid grid-cols-4 text-[18px] border-b-[1px] border-gray border-r-[1px] border-l-[1px] max-sm:grid-cols-2 "
          ...
          {props.status === 'IN_PROGRESS' &&<div className="p-3 text-left"><p className="bg-violet-100 text-violet-700 font-bold text-[14px] w-max pl-3 pr-3 pt-1 pb-1 rounded-lg">in-progress</p></div>}
